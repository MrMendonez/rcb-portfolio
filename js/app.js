  ...
  data: {
    ...
    bioSection: {
      ...
      descriptions: [
        ...
        `<i class="fa fa-code fa-2x"></i> Currently, I am a front-end web developer at Nucleus Global, a world-wide medical communications company. My responsibilities include the full-cycle development of responsive websites, electron desktop apps, and augmented-reality apps showcasing clinical trials hosted online and at congresses throughout the world each with over 10,000 medical attendees in the pharmaceutical space. Medical clients I've developed web apps for include Novartis, Celgene, Merck, Bristol-Myers Squibb, Abbvie, Boehringer Ingelheim, Gilead, Novo Nordisk, Amgen, GSK, Seattle Genetics, Pfizer, and more.`,
