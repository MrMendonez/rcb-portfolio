  ...
  data: {
    ...
    bioSection: {
      ...
      descriptions: [
        ...
        '<i class="fa fa-graduation-cap fa-2x"></i> In April 2016, I completed training to become a full-stack web developer through Rutgers Coding Bootcamp, a rigorous yet exciting program where I gained in-depth web development skills in AngularJS, APIs, NodeJS, MySQL, Express, and so much more.',
      ]
    },
    projectsSection: {
      title: 'Projects',
