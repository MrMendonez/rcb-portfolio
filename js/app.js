  ...
  data: {
    ...
    bioSection: {
      ...
      descriptions: [
        ...
        `<i class="fa fa-code fa-2x"></i> I am a Senior Applications Engineer on the Data Science Platform team at Medidata Solutions. My project is a web app that enables ingestion and standardization of clinical datasets into the Medidata platform. This data is then analyzed and used in various Medidata products, delivering value and insights to customers including, but not limited to, Pfizer and Moderna for their COVID-19 vaccine clinical trials.`,
