  ...
  data: {
    ...
    bioSection: {
      ...
      descriptions: [
        ...
        `<i class="fa fa-code fa-2x"></i> I am a Senior Applications Engineer on the Data Science Platform team at Medidata Solutions. I am the Front-End Tech Lead on my project called 'MEDS Ingestor' which is a React app enabling ingestion of clinical datasets where it is processed and visualized through other Medidata products, delivering insights to more than one million registered users which includes playing a crucial role for Moderna's COVID-19 vaccine clinical trials.`,
