  ...
  data: {
    ...
    bioSection: {
      ...
      descriptions: [
        ...
        `<i class="fa fa-code fa-2x"></i> Currently, I am a front-end web developer at <a href="https://www.linkedin.com/company/the-nucleus-group/about/" target="_blank">Nucleus Global</a>, a world-wide medical communications company. My responsibilities include the creation, development, and implementation of responsive websites, touchscreen kiosks, augmented-reality apps, and web solutions for mobile and desktop devices. Medical clients I\'ve developed web apps for include Novartis, Celgene, Merck, Bristol-Myers Squibb, Abbvie, Boehringer Ingelheim, Gilead, Novo Nordisk, Amgen, GSK, Seattle Genetics, Pfizer, and more.`,
        `<i class="fa fa-graduation-cap fa-2x"></i> I'm a graduate from the New Jersey Institute of Technology with a Bachelor's in Computer Engineering, Rutgers University with a Master's in Education, and <a href="https://bootcamp.rutgers.edu/" target="_blank">Rutgers Coding Bootcamp</a>, where I gained the skills to become a full-stack web developer. Overall, as a life-long learner, I continue to learn more in everything I do as I strive to become the best version of myself.`,
      ]
    },
    projectsSection: {
      title: 'Projects',
