  ...
  data: {
    ...
    bioSection: {
      ...
      descriptions: [
        ...
        `<i class="fa fa-code fa-2x"></i> I am a Senior Applications Engineer on the Data Science Platform team at Medidata Solutions. I am a Tech Lead on two teams working on SaaS products that deliver insight on clinical trial data to more than one million registered users including Moderna's COVID-19 vaccine trials.`,
