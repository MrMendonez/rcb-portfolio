  ...
  data: {
    ...
    bioSection: {
      ...
      descriptions: [
        ...
        `<i class="fa fa-graduation-cap fa-2x"></i> I'm a graduate from NJIT with a Bachelor's in Computer Engineering, Rutgers University with a Master's in Education, and <a href="https://bootcamp.rutgers.edu/" target="_blank">Rutgers Coding Bootcamp</a>, a rigorous yet exciting program, where I gained the skills to become a full-stack web developer.`,
      ]
    },
    projectsSection: {
      title: 'Projects',
