  ...
  data: {
    ...
    bioSection: {
      ...
      descriptions: [
        ...
        '<i class="fa fa-code fa-2x"></i> Currently, I am a front-end web developer at <a href="https://www.synaptikdigital.com/" target="_blank">Synaptik Digital</a>, a world-wide medical communications company. My responsibilities include the creation, development, and implementation of internal and external websites, Angular applications for touchscreen kiosks, and web solutions for mobile and desktop devices. Medical and pharmaceutical clients I\'ve developed web apps for include but are not limited to - Novartis, Celgene, Merck, Bristol-Myers Squibb, Abbvie, Boehringer Ingelheim, Gilead, Novo Nordisk, Amgen, GSK, Seattle Genetics, and Pfizer.',
        '<i class="fa fa-graduation-cap fa-2x"></i> In April 2016, I completed training to become a full-stack web developer through Rutgers Coding Bootcamp, a rigorous yet exciting program where I gained in-depth web development skills in tools including AngularJS, APIs, NodeJS, MySQL, Express, and so much more.',
      ]
    },
    projectsSection: {
      title: 'Projects',
      ...
      projects: [
        {
          ...
          description: 'This is an example of many touchscreen kiosks I\'ve developed for some of the world\'s most profitable pharmaceutical companies. Congresses where my Angular kiosks have been displayed include but not limited to are <a href="https://www.hematology.org" target="_blank">2017 & 2018 American Society of Hematology</a>, <a href="https://meetings.asco.org" target="_blank">2017 & 2018 American Society of Clinical Oncology</a>, and <a href="https://www.aad.org/" target="_blank">2018 American Academy of Dermatology</a>. Each of these major congresses have over 18,000 attendees including over 10,000 medical personnel. All medical and business data have been removed for demo purposes.',
          tools: [
